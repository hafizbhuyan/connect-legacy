...
export default function PrivacyPolicy () {
    return (
        <>
            <Header pageTitle={'Privacy Policy | Drivense'} />
            <Navbar />

            <h1>Our Privacy Policy</h1>
			<div>
				<p>
					Drivense LLC built Drivense Connect as a Free app and the Connect Card as a paid service.
					This page is used to inform visitors regarding our policies with the collection, use, and disclosure of
					Personal Information if anyone decided to use our Service. If you choose to use our Service, then you
					agree to the collection and use of information in relation to this policy. The Personal Information
					...
					same meanings as in our Terms and Conditions, which is accessible at Drivense Connect unless otherwise
			...
			<div class="policy-section">
				<h3>Contact Us</h3>
				<p>
					If you have any questions or suggestions about our Privacy Policy, do not hesitate to <a href="mailto:support@drivense.com">Contact Us</a>.
				</p>
			</div>
